...
namespace Microsoft.FamilyShowLib
{
  ...
  static class GedcomConverter
  {
    ...
    static public Stream ConvertToXml(StreamReader stream, bool combineSplitValues)
    {
    ...
    /// </summary>
    static private void CombineSplitValues(Stream xmlFilePath)
    {
