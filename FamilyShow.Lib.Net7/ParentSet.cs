...
public class ParentSet : IEquatable<ParentSet>
{
    ...
    public bool Equals(ParentSet other)
    {
        if (other != null)
        {
            if (firstParent.Equals(other.firstParent) && secondParent.Equals(other.secondParent)) return true;

            if (firstParent.Equals(other.secondParent) && secondParent.Equals(other.firstParent)) return true;
        }
