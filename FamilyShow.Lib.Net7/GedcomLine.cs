    ...
    public bool Parse(string text)
    {
        try
        {
            ...
            if (tag[0] == '@')
            {
                ...
                if (pos != -1) tag = tag.Substring(0, pos);
            }
